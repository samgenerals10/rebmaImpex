...
const SEED_ARTICLES: Omit<HelpArticle, 'id' | 'created_at'>[] = [
  ...
  // CEO
  { title: 'How to use the CEO Control Center', body: 'Go to CEO → Control Center. This panel lets you: (1) Grant or revoke department-level feature access for specific staff; (2) Set up delegation to temporarily transfer your approval authority to another manager; (3) Invite new staff directly with auto-approve toggle; (4) View all pending approvals and system-wide activity logs.', category: 'CEO', department: null, created_by: 'system' },
...
const FALLBACK_ARTICLES: HelpArticle[] = [
  ...
  { id: 'f-hr-2', title: 'How to manage leave requests', category: 'HR', body: 'HR → Leave Management. Review PENDING requests to see staff name, leave type, dates, and reason. Click Approve or Reject. The staff member is notified automatically. Filter by status or department.', department: null, created_by: 'system', created_at: new Date().toISOString() },
