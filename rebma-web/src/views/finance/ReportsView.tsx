...
const MOCK_HISTORY = [
  { date: 'Dec 10, 2024', type: 'Daily Cash Report', period: 'Dec 10, 2024', generatedBy: 'Finance Admin' },
  { date: 'Dec 8, 2024', type: 'Weekly Sales Report', period: 'Week 49, 2024', generatedBy: 'Finance Admin' },
  { date: 'Dec 7, 2024', type: 'Expense Report', period: 'Dec 1–7, 2024', generatedBy: 'Finance Manager' },
  { date: 'Nov 30, 2024', type: 'Monthly P&L Statement', period: 'November 2024', generatedBy: 'Finance Admin' },
  { date: 'Nov 30, 2024', type: 'VAT Report (GRA Format)', period: 'November 2024', generatedBy: 'Finance Admin' },
];
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={() => exportToCSV(MOCK_HISTORY, ['date', 'type', 'period', 'generatedBy'], 'report_history')} className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[var(--border)] text-xs text-[var(--text-secondary)] hover:bg-[var(--bg-input)]"><Download size={12} /> Export</button>
        </div>
